 ...
 * format of objects in Java to rows in a
 * database. The methods here are mostly filled out, you will just need to 
 * add a SQL statement.
 *
...
public class FlightDAO {
     ...
     *
     * You only need to change the sql String and set preparedStatement 
     * parameters.
     *
     * @return all flights.
     */
     ...
     * parameters.
     *
     * Remember that the format of a select where statement written as a Java
     ...
     * You can use the getters already written in the Flight class to retrieve 
     * its values (getDeparture_city(),
     * getArrival_city()). The flight_id will be automatically generated by the
     *  SQL database, and JDBC will be able
     * to retrieve the generated ID automatically. That means that you when 
     * you insert the flight, you only need
     * to define the departure_city and arrival_city values (two columns total!)
     *
     * You only need to change the sql String and set preparedStatement 
     * parameters.
     *
     * Remember that the format of a insert PreparedStatement written as a 
     * string works something like this:
    ...
    public Flight insertFlight(Flight flight){
        Connection connection = ConnectionUtil.getConnection();
        try {
            //Write SQL logic here. When inserting, you only need to define
            // the departure_city and arrival_city
    ...
    /**
     * TODO: Update the flight identified by the flight id to the values 
     * contained in the flight object.
     *
     * You only need to change the sql String and set preparedStatement 
     * parameters.
     *
     * Remember that the format of an update PreparedStatement written as a 
     * Java String looks something like this:
     ...
     *
     * @param id a flight ID.
     * @param flight a flight object. the flight object does not contain a 
     * flight ID.
     */
